...
argocd app create $i --repo https://github.com/MMR-46org/$i --path k8s --dest-namespace default --dest-server https://kubernetes.default.svc --directory-recurse --sync-policy none --grpc-web
argocd app sync $i
done